...
class SaveImage(LocalPlugin):
    ...
    def __init__(self, fv, fitsimage):
        ...
        super(SaveImage, self).__init__(fv, fitsimage)
        ...
        self.suffix = self.settings.get('output_suffix', 'stginga')

        fv.add_callback('add-image', lambda *args: self.redo())
...
Output image will have the filename of <inputname>_<suffix>.fits.""")
    ...
    def redo(self):
        ...
        for key in func():
            ...
            if path is None:  # Special handling for mosaic
                infile = key
            else:
    ...
    def _write_mosaic(self, key, outfile):
        """Write out mosaic data to single-extension FITS."""
