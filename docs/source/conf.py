# -*- coding: utf-8 -*-
#
# stginga documentation build configuration file, created by
...
version = stginga.__version__
# The full version, including alpha/beta/rc tags.
release = stginga.__version__
...
latex_documents = [
  (master_doc, 'stginga.tex', u'stginga Documentation',
   u'STScI', 'manual'),
]
...
man_pages = [
    (master_doc, 'stginga', u'stginga Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'stginga', u'stginga Documentation',
   author, 'stginga', 'One line description of project.',
   'Miscellaneous'),
]
